...
class Menu(models.Model):
    ...
    parent = models.ForeignKey("self", null=True, on_delete=models.CASCADE, blank=True, verbose_name="父菜单")
...
class Structure(models.Model):
    ...
    parent = models.ForeignKey("self", null=True, on_delete=models.CASCADE, blank=True, verbose_name="父类架构")
...
class UserProfile(AbstractUser):
    ...
    department = models.ForeignKey("Structure", null=True, on_delete=models.CASCADE, blank=True, verbose_name="部门")
    post = models.CharField(max_length=50, null=True, blank=True, verbose_name="职位")
    superior = models.ForeignKey("self", null=True, on_delete=models.CASCADE, blank=True, verbose_name="上级主管")
